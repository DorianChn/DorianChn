...
> 每天中午12:00更新，从GitHub精选skill蒸馏成新手能看懂的版本
...
```
每天：
1. 从GitHub hermes-agent skills中选择一个
2. 蒸馏成150-200行的简化版
3. 保存到本目录
4. 自动更新本README
5. 推送到GitHub
...
### AI/ML 入门
- [skill-ml-intro.md](skill-ml-intro.md) - 机器学习入门

### 开发工具
- [skill-github.md](skill-github.md) - GitHub仓库管理
- [skill-webapp.md](skill-webapp.md) - 单文件Web应用开发
- [skill-docker.md](skill-docker.md) - Docker容器化部署
...
- **2026-08-04** - 添加 skill-xlsx.md（Excel文件处理）

---

<div align="center">

**每天一个skill，四年后成为AI工程师**
